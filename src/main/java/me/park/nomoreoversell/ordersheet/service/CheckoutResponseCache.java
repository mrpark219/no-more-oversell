...
public class CheckoutResponseCache {
    ...
    private static final String CIRCUIT_BREAKER_NAME = "checkoutResponseCache";
    ...
    public Optional<CheckoutResponse> get(Long userId, Long stayProductId) {
        ...
        return circuitBreaker.run(
                ...
                throwable -> {
                    log.warn("체크아웃 응답 캐시 fallback. userId={}, stayProductId={}", userId, stayProductId, throwable);
    ...
    public void put(Long userId, Long stayProductId, CheckoutResponse response) {
        ...
        circuitBreaker.run(
                ...
                throwable -> {
                    log.warn("체크아웃 응답 캐시 저장 fallback. userId={}, stayProductId={}", userId, stayProductId, throwable);
                    return null;
                }
        );
    }
